...
void ModelKris::setup(string path, float fboWidth, float fboHeight) {
...
void ModelKris::update(float speed) {
...
void ModelKris::drawInFbo() {
	fbo.begin();
	draw();
	fbo.end();
}

void ModelKris::drawFbo(float x, float y) {
	fbo.draw(x, y);
}
